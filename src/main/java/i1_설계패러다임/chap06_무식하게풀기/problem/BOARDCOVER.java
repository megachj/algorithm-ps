...
public class BOARDCOVER {
    ...
    public static final List<List<Pair<Integer, Integer>>> shapeList = Arrays.asList(
    ...
    public static boolean cover(int y, int x, List<Pair<Integer, Integer>> shape) {
        int dy, dx;
    ...
    public static void uncover(int y, int x, List<Pair<Integer, Integer>> shape) {
        int dy, dx;
        for (Pair<Integer, Integer> dp: shape) {
            dy = dp.getKey();
            dx = dp.getValue();
